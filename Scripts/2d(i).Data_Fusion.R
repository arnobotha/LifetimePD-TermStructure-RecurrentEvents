...
# SCRIPT AUTHOR(S): Dr Arno Botha, Esmerelda Oberholzer, Roelinde Bester, Marcel Muller, Roland Breedt, Bernard Scheepers
# ---------------------------------------------------------------------------------------
# -- Script dependencies:
#   - 0.Setup.R
#   - 1.Data_Import.R
...
datCredit_real <- subset(datCredit_real, select = -c(Age, AccountStatus, DelinqState_g0,
                                                     ...
                                                     CLS_STAMP, BOND_IND, PerfSpell_Event,
                                                     DefSpell_Event))
...
# Total exclusions' impact:  10.28492%
...
### RESULTS: 93.4 % of observations have not defaulted in exactly 12 months since reporting date and 6.6% did.
...
### RESULTS: 91.98% of observations have not defaulted in the next 12 months from reporting date, whilst 8.02% of accounts had.
# Relocate variable next to current default status variable
...
### RESULTS: 11.5% of records had previous defaults, which is 6.9% of accounts
...
### RESULT: 96.07% of the records had no change in their delinquency level from their associated previous record.
