...
#
# Thereafter, this script applies the following Advanced Data Treatments:
...
#   5)  Trailing zero-valued balances (TZB); treated with TruEnd-procedure from Botha2023..
...
#
# Finally, given the obscurities revealed by the previous treatments, re-apply previous exclusions
# ---------------------------------------------------------------------------------------
# -- Script dependencies:
#   - 0.Setup.R
#   - 1.Data_Import.R
...
rm(LoanIDs, datExcl, datExclusions); gc() # memory optimization; no need for raw data anymore at this point
