...
# Used within tROC.multi within a multi-threaded loop in estimating the survival probability at a given
# prediction time (implicit within Vmarkers) and, more importantly, at a given threshold.
